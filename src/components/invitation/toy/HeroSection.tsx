...
interface Props {
  strings: ToyStrings;
  /** Joined couple name, e.g. "Jasur & Nilufar" (or a single name). */
  name: string;
  dateLabel: string;
  photoUrl: string;
  /** Triggers the laurel draw-in animation once the invitation is opened. */
  animate: boolean;
}
    ...
    <section className={styles.hero}>
      <div className={`${styles.heroCard} ${animate ? styles.animateLaurel : ""}`}>
        ...
        <div className={styles.photoFrameContainer}>
          <LaurelDecoration side="left" />
          <LaurelDecoration side="right" />
